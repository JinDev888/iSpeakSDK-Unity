...
public class Web3GL
{
    ...
    [DllImport("__Internal")]
    public static extern void SendTransactionJsData(string to, string value, string gasPrice, string gasLimit, string data);
    ...
    [DllImport("__Internal")]
    public static extern void SignMessage(string value);
    ...
    [DllImport("__Internal")]
    public static extern string SignMessageResponse();
    
    [DllImport("__Internal")]
    private static extern string HashMessageResponse();

    [DllImport("__Internal")]
    public static extern void SetSignMessageResponse(string value);
    ...
    [DllImport("__Internal")]
    public static extern void SetNetwork(int chainID);
    [DllImport("__Internal")]
    public static extern void Web3Connect();

    [DllImport("__Internal")]
    public static extern string ConnectAccount();
